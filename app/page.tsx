...
export default function Whensubs() {
  return (
    <main className="min-h-screen bg-[#F4F4F4] bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-900/50 dark:to-gray-800/50 relative overflow-hidden font-zen-antique-soft">
      <BackgroundOrbs />
      <Navbar />
      <HeroSection />
